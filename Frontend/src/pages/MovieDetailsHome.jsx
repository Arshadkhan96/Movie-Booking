...
export default function MovieDetailPage() {
  ...
  const posterSrc =
    ...
    movie.poster ||
    movie.posterUrl ||
    "https://dummyimage.com/320x480/cccccc/000000&text=No+Poster";
              ...
              >
                <img
                  ...
                  onError={(e) => {
                    ...
                    e.currentTarget.src =
                      "https://dummyimage.com/320x480/cccccc/000000&text=No+Image";
                  }}
                        ...
                        {c.img || c.preview || c.file ? (
                          <img
                            ...
                            onError={(e) => {
                              e.currentTarget.onerror = null;
                              e.currentTarget.src =
                                "https://dummyimage.com/80x80/cccccc/000000&text=A";
                            }}
                          />
                        ) : (
